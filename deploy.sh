...
# main config
PLUGINSLUG="easy-digital-downloads-related-downloads"
CURRENTDIR=`pwd`
MAINFILE="edd-related-downloads.php" # this should be the name of your main php file in the wordpress plugin
